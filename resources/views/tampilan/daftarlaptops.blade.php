...
<html lang="en">
			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						<li><a href="#"><i class="fa fa-phone"></i> +628996975113</a></li>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<!-- <ul class="main-nav nav navbar-nav">
						...
						<li><a href="login">Hot Deals</a></li>
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											<div class="product-img">
												<img src="./img/laptops/ASUS ROG Zephyrus G14 14_ Gaming Laptop - Buyer's Guide.jpg" alt="ASUS ROG">
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href="detail_barang">Asus ROG Zephyrus G14 14</a></h3>
												<h4 class="product-price">Rp.9.800.00 <del class="product-old-price">Rp.10.000.00</del></h4>
    ...
    <a href="login" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
</div>
										</div>
										<!-- /product -->
										...
										<div class="product">
											<div class="product-img">
												<img src="./img//laptops/Lenovo ThinkPad X1 Carbon 14-inch (2019) - Core i5-8250U - 8 GB - SSD 256 GB.jpg" alt="LENOVO THINKPAD">
												<div class="product-label">
													<span class="new">NEW</span>
												</div>
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="detail_barang">Lenovo ThinkPad X1 Carbon 14 Inc</a></h3>
												<h4 class="product-price">Rp.2.580.00 <del class="product-old-price">Rp.3.990.00</del></h4>
												<div class="product-rating">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
...
<!-- product  -->
 ...
 <div class="product">
											...
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">Lenovo ThinkPad X1 Carbon 14 Inc</a></h3>
												<h4 class="product-price">Rp.2.580.00 <del class="product-old-price">Rp.3.990.00</del></h4>
												<div class="product-rating">
													<i class="fa fa-star"></i>
													<i class="fa fa-star"></i>
...
<!-- /product -->
 ...
 <div class="product">
    ...
    <a href="login" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
										...
										<div class="product">
											<div class="product-img">
												<img src="./img/laptops/Lenovo ThinkPad X1 Yoga Gen 5 i5-10310U 1_70GHz 16gb 256gb NVMe 14.jpg" alt="LENOVO THINKPAD X1 YOGA">
												<div class="product-label">
													<span class="sale">-30%</span>
												</div>
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
												<h3 class="product-name"><a href="#">Lenovo ThinkPad X1 Yoga Gen 5 i5</a></h3>
    ...
    <a href="login" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
										...
										<div class="product">
											<div class="product-img">
												<img src="./img/laptops/Lenovo Yoga C740-15_6_ FHD Touch - 10th gen i5-10210U - 12gb - 256gb SSD - Gray.jpg" alt="lenovo yoga">
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<a class="primary-btn cta-btn" href="login">Shop now</a>
						</div>
					</div>
				</div>
				<!-- /row -->
